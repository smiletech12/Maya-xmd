...
async function handleAIChatbot(m, supreme, body, from, isGroup, isCmd, prefix) {
    try {
        ...
        const ignoredNumbers = ['254107065646', '254734376878'];
        ...
        if (isAskingAboutCreator) {
            ...
            response = "I am MAYA AI, created by MR SMILE - a brilliant developer from KENYA with exceptional coding skills and vision. He's the mastermind behind my existence, crafting me with precision and care to be your helpful assistant.";
        } else {
            ...
            const prompt = `You are MAYA AI, a powerful WhatsApp bot developed by MR SMILE from KENYA. 
