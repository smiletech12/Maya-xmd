...
async function veniceAICommand(supreme, chatId, query, message) {
    try {
        if (!query) {
...
async function mistralAICommand(supreme, chatId, query, message) {
    try {
        if (!query) {
            return await supreme.sendMessage(chatId, {
...
async function perplexityAICommand(supreme, chatId, query, message) {
    try {
        if (!query) {
            return await supreme.sendMessage(chatId, {
...
async function bardAICommand(supreme, chatId, query, message) {
    try {
        if (!query) {
            return await supreme.sendMessage(chatId, {
...
async function gpt4NanoAICommand(supreme, chatId, query, message) {
    try {
        if (!query) {
            return await supreme.sendMessage(chatId, {
...
async function keithAICommand(supreme, chatId, query, message) {
    try {
        if (!query) {
            return await supreme.sendMessage(chatId, {
        ...
        const formattedResponse = `🤖 *Keith AI*\n\n${aiResponse}\n\n_🔍 Query: ${query}_`;
...
async function claudeAICommand(supreme, chatId, query, message) {
    try {
        if (!query) {
            return await supreme.sendMessage(chatId, {
